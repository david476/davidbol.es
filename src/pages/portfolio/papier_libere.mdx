...
- Completely open source, including libraries (API clients at least).
- Local image processing, optional cloud storage of the result.
- Works on any computer, including mobile devices.
