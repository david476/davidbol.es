...
This is a selection of my more complete, interesting, and/or new projects. Click through to learn more about them!
...
<Link to='/portfolio/live_rego_code_blocks'>
  ...
  > that enables interactive example blocks of Rego code that can be interwoven with explanatory text. The code
  > blocks are evaluated asynchronously at site build-time and their hydration is heavily optimized; even on pages with hundreds
  > of editors, the visible ones can be interacted with almost instantaneously.
...
<Link to='/portfolio/papier_libere'>
  ...
  > of existing "smart paper" ecosystems, I decided to develop my own. Currently under the working title of
  > Papier Libéré ("paper, freed" in French), it's still very much in a prototype state, both in terms of features
  > and code quality, but the site and image importing process is functional. Click though and check out the gallery!
...
<Link to='/portfolio/knitting'>

  > # Knitting
  >
  > `Art`
  > 
  > I've taken up knitting in college, here's a few of my pieces!

</Link>

<Link to='/portfolio/ceramics'>

  > # Ceramics
  >
  > `Art`
  > 
  > I took a semester of ceramics during highschool to fulfill my art requirements and enjoyed it so much that I took it again.
  > Many of the pieces I made had a technical or scientific twist to them.
