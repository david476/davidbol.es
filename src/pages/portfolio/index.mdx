...
<Link to='/portfolio/electronics_labs'>
...
<Link to='/portfolio/mechanics_and_vibrations'>
  ...
  > some fun projects including a "minus k" compressed-spring vibration isolation system and fully closed-loop
